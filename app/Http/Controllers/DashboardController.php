...
class DashboardController extends Controller
{
    ...
    public function index() {
        ...
        $details = \App\Models\SaleDetail::where('description', '!=', '')
        ...
        $best_product = \App\Models\Product::orderBy('odr', 'desc')
                        ->take(5)
                        ->get();

        // get product where min_stock <= stock
        $stock_danger = \App\Models\Product::whereRaw('min_stock <= stock')->get();
